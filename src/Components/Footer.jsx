    ...
    >
      <div className="container mx-auto px-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Project Info */}
          <div>
            <h2 className=" text-4xl sm:text-45 lg:text-4xl text-color2 font-semibold mb-4 font-Rochester">
              FoodBites
            </h2>
            <p className="text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/food" className="hover:underline text-color2">
                  Available Foods
                </Link>
              </li>
              <li>
                <Link to="/manage" className="hover:underline text-color2">
                  Manage Foods
                </Link>
              </li>
              <li>
                <Link to="/foodRequest" className="hover:underline text-color2">
                  Food Request
                </Link>
              </li>
            </ul>
